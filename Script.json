...
MERGE (h:Habitatge {Id_Llar: Id_Llar, Carrer:Carrer, Any_Padro:Any_Padro, Municipi:Municipi, Numero:Numero})
    SET h.Id_Llar = Id_Llar, h.Carrer = Carrer, h.AnyPadro = Any_Padro, h.Municipi = Municipi, h.Numero = Numero
return h
...
CREATE (f1)-[:Familia {Relacio_Harmonitzada:Relacio_Harmonitzada}]->(f2)
return *
